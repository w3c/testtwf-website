...
| may | Behavior tested is preferred but OPTIONAL. [RFC2119][5] (These tests must be reviewed by a test suite owner or peer.) |
...
Although type="application/javascript" and type="application/ecmascript" are recommended by [RFC4329][7], the CSS 2.1 test suite only accepts type="text/javascript".
...
* Avoid making assumptions that are not in the "[most of the test suite makes the following assumptions][8]" list and document any that you do.
...
* Guidelines on designing the content of the test can be found in the [CSS2.1 Test Case Authoring Guidelines][9].
...
<!-- RH: Jekyll is choking on this snippet. I have no idea 
         how to make it happy. Please advise 
...
[5]: http://www.w3.org/Style/CSS/Test/Fonts/Ahem
[6]: http://www.ietf.org/rfc/rfc2119.txt
[7]: http://www.ietf.org/rfc/rfc4329.txt
[8]: http://test.csswg.org/suites/css2.1/20110323/#common
[9]: http://www.w3.org/Style/CSS/Test/guidelines.html