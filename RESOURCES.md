...
List of all test-related documentation on W3C properties that needs to be assessed, used, modified or deleted.

## HTML WG ##
- http://www.w3.org/html/wg/wiki/Testing
- http://www.w3.org/html/wg/wiki/Testing/Approval/
- http://www.w3.org/html/wg/wiki/Testing/Authoring/
- http://www.w3.org/html/wg/wiki/Existing_Html5_Tests
- http://www.w3.org/wiki/HtmlTestMaterials
...
- http://wiki.csswg.org/test/review
- http://wiki.csswg.org/test/oversight
- http://wiki.csswg.org/test/implementation-report
- http://fantasai.inkedblade.net/style/tests/about/css21ts/
- http://wiki.csswg.org/test/css2.1/harness
- http://wiki.csswg.org/test/harness
- http://wiki.csswg.org/test/review-system
- http://wiki.csswg.org/test/build-system
- http://www.w3.org/Style/CSS/Test/
- http://wiki.csswg.org/test/css2.1
- http://wiki.csswg.org/test/paged-media
- http://wiki.csswg.org/test/css3.0

## Coremob CG ##
- http://www.w3.org/community/coremob/wiki/Tests/Acceptance_Criteria
- http://coremob.github.com/coremob-test-approach/
...
- http://lists.w3.org/Archives/Public/public-html-testsuite/2010Apr/0016.html
- http://www.w3.org/wiki/Guide#Test
- http://www.w3.org/wiki/Guide/ContributeTest
- https://www.w3.org/Guide/#testsuites
- http://www.w3.org/QA/TheMatrix
